...
module.exports = (bot) => {
  ...
  bot.onText(/^\/(botinfo|info)$/i, async (msg) => {
    ...
    const text = `
🤖 <b>BOT INFORMATION</b>
• <b>Bot Name:</b> ${settings.botName || 'NUEL-INSTALLER Bot'}
• <b>Version:</b> 1.0
    ...
    try {
      ...
      writer.on("finish", async () => {
        ...
        await bot.sendAudio(chatId, filePath, {
          ...
          performer: "NUEL-INSTALLERl Asisten"
        });
